    ...
    <Card className="bg-gray-800/50 border-gray-700">
      <CardHeader>
        <CardTitle className="text-white flex items-center gap-2">
          ...
          <span className="text-sm text-gray-400 font-normal ml-auto">Liga Global</span>
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        {rankings.map((player) => (
          ...
          >
            ...
            <div className="flex-1">
              <p className={`font-semibold ${player.isCurrentUser ? 'text-white' : 'text-gray-200'}`}>
                {player.name}
                {player.isCurrentUser && (
        ...
        {/* View All Button */}
        <button className="w-full mt-4 py-3 bg-gray-700/50 hover:bg-gray-700 text-gray-300 hover:text-white rounded-lg font-medium transition-colors">
